...
class M3(DeviceWithLocations):
    """
    The ophyd `Device` that is used to talk to the ARI M3 mirror section.

    The ARI M3 mirror section consists of the M3 mirror chamber, the beam
    -pipe, the associated Diagnostic and BaffleSlit sub-devices and the
    motors, detectors and vacuum signals for these. It is designed to
    provide an intuitive, tab-to-complete based, interface to find all
    the components associated with the M3 mirror.
